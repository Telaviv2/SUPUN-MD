...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'SUPUN-MD=SMlkFSDD#FrxTJddGCGbd_QVXb95mUCa3tDeO_hcHSRPonHjkS1E' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '966581462091' : process.env.OWNER_NUMBER,
